...
import org.primaresearch.dla.page.io.*;
...
import org.primaresearch.io.xml.*;
...
//		try {
////			reader.read(new FileInput(new File("/scratch/tmp/val_16-2-2022/page/NL-HaNA_1.04.02_3869_0777-groot.xml")));
//			reader.read(new FileInput(new File("/home/rutger/tmp/tiny-dataset/page/NL-HaNA_2.22.24_HCA32-1065_1386b.xml")));
//		} catch (UnsupportedFormatVersionException e) {
//			e.printStackTrace();
//		}
